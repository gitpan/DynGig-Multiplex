...
DynGig::Multiplex::CLI::TCP - CLI for DynGig::Multiplex::TCP

=cut
package DynGig::Multiplex::CLI::TCP;
...
=head1 EXAMPLE
 ...
 use DynGig::Multiplex::CLI::TCP;

 DynGig::Multiplex::CLI::TCP->main( timeout => 30, max => 30 );
